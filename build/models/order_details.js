...
exports.order_detailsStore = void 0;
const database_1 = __importDefault(require("../database"));
class order_detailsStore {
    async index() {
        try {
    ...
    async create(od) {
        try {
            const sql = "INSERT INTO order_details (order_id, id_product_order,quantity_product_order ) VALUES($1, $2, $3) RETURNING *";
            const conn = await database_1.default.connect();
            const result = await conn.query(sql, [
                od.order_id,
                od.id_product_order,
            ...
            throw new Error(`Could not add new order_details ${od.order_id}. Error: ${err}`);
        }
    }
    async delete(id) {
        try {
...
exports.order_detailsStore = order_detailsStore;
